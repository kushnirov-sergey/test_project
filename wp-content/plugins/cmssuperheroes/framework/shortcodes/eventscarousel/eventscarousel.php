...
function cs_shortcode_event_carousel($atts, $content = null)
{
    ...
    <div id="cshero_eventscarousel_post_<?php echo esc_attr($date); ?>" class="cshero-eventscarousel-post <?php echo str_replace('.','-',$layout).' '.esc_attr($el_class); ?>">
