...
$output .= apply_filters('wpb_cta_text', '<span class="wpb_call_text" style="font-size: '.$call_text_font_size.';color: '.$call_text_color.';">'. $call_text . '</span>', array('content'=>$call_text));
