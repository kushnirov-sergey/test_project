...
if ( $href != '' ) {
	$output .= '<span class="' . $css_class . '"><i style="padding-right: 5px;" class="fa '. $button_icon .'"></i>' . $title . '</span>';
	$output = '<a class="wpb_button_a' . $a_class . ' ' . $button_align . '" title="' . $title . '" href="' . $href . '"' . $target . '>' . $output . '</a>';
} else {
