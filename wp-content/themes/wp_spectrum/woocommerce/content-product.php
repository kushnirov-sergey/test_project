...
<li <?php post_class( $classes ); ?>>
	<?php if ( $product->is_on_sale() ) : ?>
		<?php echo apply_filters( 'woocommerce_sale_flash', '<span class="onsale home-shop">' . __( 'Sale!', 'woocommerce' ) . '</span>', $post, $product ); ?>
	<?php endif; ?>
	<?php if ( $_spectrum_new_item ) : ?>
		<span class="new-product"><?php echo esc_attr($_spectrum_new_item); ?></span>
	<?php endif; ?>
	<?php if ( $_spectrum_best_sale ) : ?>
		<span class="best-sale-product"><?php echo esc_attr($_spectrum_best_sale); ?></span>
	<?php endif; ?>
	<div class="cshero-carousel-item-wrap">
		...
		<div class="cshero-woo-meta">
			...
			<div class="cshero-product-caegory">
				<?php echo $product->get_categories( ', ', '<span class="posted_in category-home-shop">' . _n( '', '', $cat_count, 'woocommerce' ) . ' ', '.</span>' ); ?>
			</div>
			<?php
				/**
