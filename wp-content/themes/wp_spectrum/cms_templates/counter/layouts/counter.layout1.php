<div id="<?php echo ''.$counter_id ?>" class="cshero-counter-wrap <?php echo str_replace(".","-",$layout); ?>" <?php echo ''.$wrap_style; ?>>
	...
	<?php endif; ?>
	<div class="cshero-counter-inner <?php echo ''.$extra_class; ?> <?php echo ''.$align; ?>">
		<?php if( $icon ): ?>
			<span class="icon" <?php echo ''.$icon_style; ?>><i class="fa <?php echo ''.$icon; ?>"></i></span>
		<?php endif; ?>

		<div id="counter_<?php echo ''.$callback;?>" class="counter <?php echo ''.$type;?>" <?php echo ''.$counter_styles;?> <?php echo implode(' ', $data_render); ?>></div>
