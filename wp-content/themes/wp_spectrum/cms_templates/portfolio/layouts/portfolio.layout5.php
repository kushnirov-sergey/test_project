                ...
                <div class="cshero-portfolio-content-wrap-inner">
                    ...
                    <div class="link-wrap">
                        ...
                        if($portfolio_link !='' && $show_link){
                            echo '<a class="more" href="' . esc_url($portfolio_link) . '" target="_blank"><span>'.esc_html($link_text).'</span></a>';
                        }
                        if($read_more){
                            echo '<a class="more" title="" href="' . esc_url(get_the_permalink())  . '" ><span>'.esc_html($read_more_text).'</span></a>';
                        }
                        if($zoom){
                            echo '<a href="'.esc_url($full_image).'" class="zoom colorbox"><span>'.esc_html($zoom_text).'</span></a>';
                        }
                        ?>
                    </div>
                </div>
