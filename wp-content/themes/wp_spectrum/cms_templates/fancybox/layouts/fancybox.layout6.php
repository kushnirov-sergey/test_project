<div id="<?php echo esc_attr($fancybox_id); ?>" class="cshero-fancybox-wrap <?php echo esc_attr($fancy_wrap.' '.$custom_class.' '.$content_align.' '.$animate_class); ?>" <?php echo ''.$box_style;?>>
    ...
    <div class="cshero-fancybox-effect">
        ...
        <?php if ( !empty( $content ) || !empty( $read_more ) ) : ?>
            <div class="cshero-fancybox-content">
                <div class="cshero-fancybox-hover">
                    ...
                    <?php endif; ?>
                    <svg style="fill: #222;" height="60px" preserveAspectRatio="none" version="1.1" viewBox="0 0 100 100" width="100%" xmlns="http://www.w3.org/2000/svg"><path d="M0 0 L50 100 L100 0" stroke-width="0"/></svg>
                </div>
            </div>
        <?php endif; ?>
    </div>
