                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php if ( have_posts() ) : ?>
                            ...
                            <header class="page-header">
                                <h1 class="page-title"><?php printf( __( 'Search Results for: %s', 'wp_spectrum' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
                            </header><!-- .page-header -->
                            <?php endif; ?>
                            <?php /* Start the Loop */ ?>
                            <?php while ( have_posts() ) : the_post(); ?>
                                 ...
                                 */
                                get_template_part( 'framework/templates/blog/blog_search');
                                ?>
