<?php
/*
Template Name: Blog Masonry Gird
*/
get_header(); ?>
<?php global $post,$breadcrumb,$masonry_filter,$pagetitle; ?>
<?php
...
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area blog-masonry<?php if(!$pagetitle){ echo ' no_breadcrumb_page_blog'; }; ?> <?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?><?php echo esc_attr($layout->class); ?>">
            ...
            <div class="row">
                ...
                <div class="content-wrap <?php echo esc_attr($layout->blog); ?>">
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php
                        if($masonry_filter){
                            get_template_part( 'framework/templates/blog/masonry/masonry','filter');
                        }
                        ?>
                        <?php $post_list = new WP_Query('post_type=post&paged='. $paged . '&cat=' . $category .'&posts_per_page=' . $limit );?>
                        ...
                        <?php else : ?>
                            ...
                            <?php get_template_part( 'framework/templates/blog/masonry/blog', 'none' ); ?>
