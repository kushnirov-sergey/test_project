...
class CS_Recent_Post_Widget_V2 extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'cs_recent_post_v2', __('CS Recent Posts V2','wp_spectrum'), array('description' => __('Recent Posts Widget.', 'wp_spectrum'),)
        );
    }
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('Recent Posts', 'wp_spectrum' ) : $instance['title'], $instance, $this->id_base);
    ...
    function form($instance) {
        ...
        <p>
            <label for="<?php echo ''.$this->get_field_id('show_date'); ?>"><?php _e( 'Show date:', 'wp_spectrum' ); ?></label>
		...
		<p>
            <label for="<?php echo ''.$this->get_field_id('show_decs'); ?>"><?php _e( 'Show Description:', 'wp_spectrum' ); ?></label>
