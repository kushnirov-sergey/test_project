...
class WW_News_Tabs_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                'ww_news_tabs', __('CS News Tab Widget', 'wp_spectrum'), array('description' => __('Popular post, recent post and comments.', 'wp_spectrum'),)
        );
    }
            ...
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs">
                    <?php if ($show_popular_posts == 'true'): ?>
                        <li class="active"><a href="#tab1" data-toggle="tab"><?php echo __('Popular', 'wp_spectrum'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_recent_posts == 'true'): ?>
                        <li><a href="#tab2" data-toggle="tab"><?php echo __('Recent', 'wp_spectrum'); ?></a></li>
                    <?php endif; ?>
                    <?php if ($show_comments == 'true'): ?>
                        <li><a href="#tab3" data-toggle="tab"><?php echo __('Comments', 'wp_spectrum'); ?></a></li>
                    <?php endif; ?>
                </ul>
                                    ...
                                    <?php while ($popular_posts->have_posts()): $popular_posts->the_post(); ?>
                                        <li>
                                            ...
                                            <div class="cs-details table-cell">
                                                ...
                                                <div class="readmore">
                                                    <a href="<?php the_permalink(); ?>"><?php echo __('Read More...','wp_spectrum') ?></a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php endwhile; ?>
