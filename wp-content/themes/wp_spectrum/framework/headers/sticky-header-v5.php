        ...
        <div class="row">
            <div class="cshero-logo logo-sticky col-xs-6 col-sm-6 col-md-3 col-lg-3">
                <a href="<?php echo home_url(); ?>">
                    <img src="<?php echo ''.$smof_data['logo_header_sticky']['url']; ?>" alt="<?php bloginfo('name'); ?>" class="sticky-logo" style="max-height: <?php echo esc_attr($smof_data["header_sticky_logo_max_height"]); ?>" />
                </a>
            </div>
